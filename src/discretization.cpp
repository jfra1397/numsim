...
{
    double result = (u(i+1,j) - 2*u(i,j) + u(i-1,j))/(meshWidth_[0]*meshWidth_[0]);
    return result;
}
...
{
    double result = (u(i,j+1) - 2*u(i,j) + u(i,j-1))/(meshWidth_[1]*meshWidth_[1]);
    return result;
}
...
{
    double result = (v(i+1,j) - 2*v(i,j) + v(i-1,j))/(meshWidth_[0]*meshWidth_[0]);
    return result;
}
...
{
    double result = (v(i,j+1) - 2*v(i,j) + v(i,j-1))/(meshWidth_[1]*meshWidth_[1]);
    return result;
}
...
{
    double result = (f(i,j)-f(i-1,j))/meshWidth_[0];
    return result;
}
...
{
    double result = (g(i,j)-g(i,j-1))/meshWidth_[1];
    return result;
}
...
{
    double result = (p(i+1,j)-p(i,j))/meshWidth_[0];
    return result;
}
...
{
    double result = (p(i+1,j) - 2*p(i,j) + p(i-1,j))/(meshWidth_[0]*meshWidth_[0]);
    return result;
}
...
{
    double result = (p(i,j+1) - 2*p(i,j) + p(i,j-1))/(meshWidth_[1]*meshWidth_[1]);
    return result;
}
