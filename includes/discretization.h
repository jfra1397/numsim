...
public:
    ...
    Discretization(const std::array<int, 2> nCells, const std::array<double, 2> physicalSize,double tInit);
    ...
    void write_to_file(int fileNo, double time, std::string outputPath) const;
